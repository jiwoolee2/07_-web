...
public class BoardDTO {
	...
	public String getBoardContetn() {
		return boardContent;
	}


	public void setBoardContetn(String boardContetn) {
		this.boardContent = boardContetn;
	}
	...
	public String toString() {
		return "BoardDTO [boardNo=" + boardNo + ", boardCategory=" + boardCategory + ", boardWriter=" + boardWriter
				+ ", boardTitle=" + boardTitle + ", boardContetn=" + boardContent + ", count=" + count + ", createDate="
				+ createDate + "]";
	}

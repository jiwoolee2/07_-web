...
<body>
	...
	<div style="width : 80%; margin : auto; padding : 50px;">
		<form action="md" name="signup" id="signUpForm" method="post"
	      ...
	      <div class="modal-body">
	        <form action="quit" method="post">
			  ...
			  <div class="form-group">
			    ...
			    <input type="password" name="userPw" class="form-control" placeholder="비밀번호를 입력해주세요." id="deletePwd" required>
			  </div>
	...
	<div class="modal" id="updatePwd">
	  <div class="modal-dialog">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <form action="np" method="post">
	        
			  <div class="form-group">
			    <label for="userPwd">현재 비밀번호 :</label>
			    <input type="password" name="userPw" class="form-control" placeholder="비밀번호를 입력해주세요." id="userPwd" required>
			  </div>
			  ...
			  <div class="form-group">
			    ...
			    <input type="password" name="agPw" class="form-control" placeholder="다시 한 번 입력해주세요." id="checkPwd" required>
			  </div>
		...
		<!-- 	<script>
			function alert(){
					if($('#userPwd').val() != $(sessionScope.loginMember.memberPw)) {
